...
echo "</div> </div> <form> <label for='opc1'>Diario</label> <input type='radio' id='opc1' name='opc1'> <label for='opc2'>Semanal</label> <input type='radio' id='opc2' name='opc2'> <label for='opc3'>Personalizado</label><input type='radio' id='opc3' name='opc3'> <input type='submit' value='Enviar'> </form> </div>"
?>
