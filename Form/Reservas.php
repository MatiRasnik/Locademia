...
for($i=14;$i<=19;$i++) {
    if(date("H", mktime($i)) < $hora) {
        echo "<label class='horario' style='background-color: lightgrey;'> <input type='checkbox' id='horario1' name='horario1' value=" . date('H:i', mktime($i, 00)) . "> <label>" . date('H:i', mktime($i, 00)) . " hs </label> </label>";
    } else {
