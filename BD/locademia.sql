...
INSERT INTO `automoviles` VALUES (12345678,'JJJ-123','A','Es un sedan'),(23456789,'PPP-456','B','Es un hatchback'),(98765432,'SVN-987','C','Es un mini');
...
CREATE TABLE `fotos` (
  ...
  PRIMARY KEY (`matricula`),
  CONSTRAINT `fotos_ibfk_1` FOREIGN KEY (`matricula`) REFERENCES `automoviles` (`matricula`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-04-17 19:42:10
